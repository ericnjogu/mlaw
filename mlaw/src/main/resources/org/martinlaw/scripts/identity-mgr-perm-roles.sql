...
INSERT INTO KRIM_ROLE_T (ACTV_IND,KIM_TYP_ID,NMSPC_CD,OBJ_ID,ROLE_ID,ROLE_NM,VER_NBR, DESC_TXT)
  VALUES ('Y','18','KR-NS','RMhzBNzn73tkCdTt19Xw7WVZjYlxzhP2rCxN','org.mlaw.roles.idmgr','martinlaw identity managers',1, 'Users who can modify entity records in Kuali Identity Management');
...
INSERT INTO KRIM_ROLE_PERM_T (ACTV_IND,OBJ_ID,PERM_ID,ROLE_ID,ROLE_PERM_ID,VER_NBR)
  VALUES ('Y','VTIBHnJEnL0EZy1pzyFBsez3Ba4l9PKPVzFj','307','org.mlaw.roles.idmgr','idmgr_307',1);
...
VALUES('idmgr_grp', 1, '6AWpQdqMmk8sGCMyeqZN1x3FhcD8Y3Dk319M', 'org.mlaw.roles.idmgr', 'org.martinlaw.group.idmgr', 'G');