...
VALUES 
('create_matter_annex_type_maint', uuid(),2,'42','KR-NS','Create MatterAnnex Type Maintenance Document','Allows user to create a new MatterAnnex Type maintenance document','Y');
...
VALUES 
('matter_annex_type_maint_doc', uuid(),1,'create_matter_annex_type_maint','56','13','MatterAnnexTypeMaintenanceDocument');
...
INSERT INTO KRIM_ROLE_PERM_T (ACTV_IND,OBJ_ID,PERM_ID,ROLE_ID,ROLE_PERM_ID,VER_NBR)
  VALUES ('Y', uuid(),'create_matter_annex_type_maint','org.mlaw.roles.functional','fnl_create_matter_annex_type',1);
