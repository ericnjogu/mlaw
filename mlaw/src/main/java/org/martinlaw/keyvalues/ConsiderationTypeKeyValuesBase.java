...
/**
 * displays consideration types whose {@link ConsiderationType#getScope()} is either empty or includes the specific matter (via the class name)
 * 
 * @author mugo
 *
 */
public abstract class ConsiderationTypeKeyValuesBase extends ScopedKeyValuesBase {
	...
	public List<KeyValue> getKeyValues(String qualifiedMatterClassName) {
		return super.getKeyValues(qualifiedMatterClassName, ConsiderationType.class);
	}
}
