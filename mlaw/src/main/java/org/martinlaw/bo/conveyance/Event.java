...
/**
 * represents an event e.g. a hearing date, meeting date etc set for a conveyance
 * 
 * @author mugo
 */
@Entity(name="conveyance_event")
@Table(name="martinlaw_conveyance_event_t")
public class Event extends MatterEvent {
	...
	public void setMatter(Conveyance m) {
		this.matter = m;
	}
}
