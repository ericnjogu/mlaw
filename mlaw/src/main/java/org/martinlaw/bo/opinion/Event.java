...
/**
 * represents an event e.g.a meeting date etc set for an opinion
 * 
 * @author mugo
 */
@Entity(name="opinion_event")
@Table(name="martinlaw_opinion_event_t")
public class Event extends MatterEvent {
	...
	public void setMatter(Opinion m) {
		this.matter = m;
