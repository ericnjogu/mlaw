...
public class Maintainable extends MatterMaintainable {
	...
	public void doRouteStatusChange(DocumentHeader documentHeader) {
		...
		if (documentHeader.getWorkflowDocument().isProcessed()) {
			createPrincipals(((Contract) getDataObject()).getParties(), MartinlawConstants.AffiliationCodes.CONTRACT_PARTY);
			createPrincipals(((Contract) getDataObject()).getSignatories(), 
					MartinlawConstants.AffiliationCodes.CONTRACT_SIGNATORY);
		}
	}
}
